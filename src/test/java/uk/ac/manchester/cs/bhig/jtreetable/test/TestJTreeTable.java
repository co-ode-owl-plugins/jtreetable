...
public class TestJTreeTable {
    ...
    public void testJTreeTable() {
        ...
        tree.setRowHeight(-1);
        final TreeTableModel<Object> model = new AbstractTreeTableModel<Object>(
                tree) {
        ...
        final JTreeTable<Object> treeTable = new JTreeTable<>(tree,
                model);
        ...
        toolbar.add(new AbstractAction("-") {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (col >= 0) {
                    int modelIndex = treeTable.getTable()
                            .convertColumnIndexToModel(col);
                    Object colObj = treeTable.getModel()
                            .getColumnObjectAtModelIndex(modelIndex);
        ...
        showConfirmDialog(null, "Test JTreeTable", panel,
                JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        System.exit(0);
    }

    public static void showConfirmDialog(JComponent parent, String title,
            JComponent content, int messageType, int optionType) {
        JOptionPane optionPane = new JOptionPane(content, messageType,
                optionType);
